...
#ifndef EMFILE_SWIFT_H
#define EMFILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EMFile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// monitored file, the <code>onExternalChange</code> callback fires. The editor
/// should then offer the user a choice: reload or keep their version.
SWIFT_CLASS("_TtC6EMFile21ExternalChangeMonitor")
@interface ExternalChangeMonitor : NSObject
...
@interface ExternalChangeMonitor (SWIFT_EXTENSION(EMFile)) <NSFilePresenter>
