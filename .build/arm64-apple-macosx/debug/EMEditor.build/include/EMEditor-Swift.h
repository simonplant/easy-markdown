...
#ifndef EMEDITOR_SWIFT_H
#define EMEDITOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EMEditor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Uses <code>NSTextLayoutManager</code> and <code>NSTextContentStorage</code> for modern text layout.
/// Supports CJK IME composition, RTL text, and unlimited undo.
SWIFT_CLASS("_TtC8EMEditor10EMTextView")
@interface EMTextView : NSTextView
...
/// with <code>.spellCheckExcluded</code> (code blocks, code spans, URLs, images).
...
SWIFT_CLASS("_TtC8EMEditor19ImageTextAttachment")
@interface ImageTextAttachment : NSTextAttachment
/// Decodes from archive. Returns nil per [A-048] (no fatalError in production).
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (NSRect)attachmentBoundsForTextContainer:(NSTextContainer * _Nullable)textContainer proposedLineFragment:(NSRect)lineFrag glyphPosition:(NSPoint)position characterIndex:(NSUInteger)charIndex SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithData:(NSData * _Nullable)contentData ofType:(NSString * _Nullable)uti SWIFT_UNAVAILABLE;
@end

@class NSNotification;
SWIFT_CLASS("_TtC8EMEditor19TextViewCoordinator")
@interface TextViewCoordinator : NSObject <NSTextViewDelegate>
